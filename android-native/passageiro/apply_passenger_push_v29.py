...
if 'PushRegistration.register(this,token,"passenger")' not in text:
    text=text.replace('    private void showHome() {\n','    private void showHome() {\n        PushRegistration.register(this,token,"passenger");\n',1)

pkg=root/'src/main/java/com/clickgo/passageiro'
pkg.mkdir(parents=True,exist_ok=True)
(pkg/'PushRegistration.java').write_text(r'''package com.clickgo.passageiro;
...
''',encoding='utf-8')
(pkg/'ClickGoMessagingService.java').write_text(r'''package com.clickgo.passageiro;
...
print('Passageiro v2.9 PRIME: infraestrutura FCM preparada; ativa quando variáveis Firebase estiverem configuradas.')
