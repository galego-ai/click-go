...
export default function OperationsManager({kind}:{kind:'drivers'|'rides'}){
 ...
 async function load(){
  ...
  if(supportId){driverQuery=driverQuery.eq('franchise_id',supportId);franchiseQuery=franchiseQuery.eq('id',supportId);linkQuery=linkQuery.eq('franchise_id',supportId)}
