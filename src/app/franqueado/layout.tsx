...
const core:NavItem[]=[
 {href:'/franqueado',label:'📊 Meu Dashboard'},
 {href:'/franqueado/mapa',label:'🗺️ Mapa ao vivo',permission:'operation'},
 ...
 {href:'/franqueado/anuncios',label:'🎯 Promoções',permission:'marketing'},
 {href:'/franqueado/suporte',label:'💬 Suporte ao Cliente',permission:'support'},
 {href:'/franqueado/configuracoes',label:'⚙️ Configurações Locais',permission:['settings','pricing','finance']},
]
const more:NavItem[]=[
